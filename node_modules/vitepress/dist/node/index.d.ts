...
import { MarkdownEnv, Awaitable, LocaleSpecificConfig, LocaleConfig, SiteData, SSGContext, PageData, HeadConfig } from '../../types/shared.js';
...
type PluginSimple$1 = (md: MarkdownIt) => void;
type PluginWithOptions$1<T = any> = (md: MarkdownIt, options?: T) => void;
type PluginWithParams$1 = (md: MarkdownIt, ...params: any[]) => void;
